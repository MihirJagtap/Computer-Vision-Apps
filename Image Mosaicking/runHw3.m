...
signAcademicHonestyPolicy('Mihir Jagtap', 'mjagtap');
...
orig_img = imread('portrait_small.png'); 
...
%PLEASE see the README FOR IMAGE CONDITIONS AND IMAGE NAME
...
imgc = im2single(imread('chair1.png'));
imgl = im2single(imread('chair2.png'));
imgr = im2single(imread('chair3.png'));
...
%figure, imshow(stitched_img);
imwrite(stitched_img, 'chair_panaroma.png');
